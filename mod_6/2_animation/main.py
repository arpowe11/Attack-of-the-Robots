...
# create the explosion instances
test_explodey_list = []  # NOQA
test_explodey_list.append(pygame.image.load("../assets/LargeExplosion1.png"))
test_explodey_list.append(pygame.image.load("../assets/LargeExplosion2.png"))
test_explodey_list.append(pygame.image.load("../assets/LargeExplosion3.png"))
Explosion(screen, 500, 500, test_explodey_list, 7, 999, False)
